...
import com.green.shoppingmall.product.model.ProductSelDetailDto;
...
public interface ProductMapper {
    ...
    ProductVo selProductById(ProductSelDetailDto dto);
    List<String> selProductPics(ProductSelDetailDto dto);
}
